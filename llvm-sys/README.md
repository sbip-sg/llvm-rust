...
- This is a fork of the [llvm-sys](https://github.com/tari/llvm-sys.rs/) to support new C bindings provided by the
  [llvm-project](https://github.com/sbip-sg/llvm-project) repository of SBIP.

- Some changes in this fork, if applicable, will be gradually merged back to the
  original [llvm-sys](https://github.com/tari/llvm-sys.rs/).
