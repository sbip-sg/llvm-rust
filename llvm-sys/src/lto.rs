...
extern "C" {
    ...
    pub fn lto_module_get_target_triple(
        _mod: lto_module_t,
    ) -> *const ::libc::c_char;
    pub fn lto_module_set_target_triple(
        _mod: lto_module_t,
    ...
    ///
    /// Added in LLVM 3.7.
    pub fn lto_module_get_linkeropts(
        _mod: lto_module_t,
    ) -> *const ::libc::c_char;
    ...
    pub fn lto_codegen_add_must_preserve_symbol(
        cg: lto_code_gen_t,
    ...
    pub fn lto_set_debug_options(
        options: *mut *const ::libc::c_char,
        number: ::libc::c_int,
    );
    pub fn lto_codegen_debug_options(
        cg: lto_code_gen_t,
    ...
    ///
    /// Added in LLVM 3.7.
    pub fn lto_codegen_set_should_internalize(
        cg: lto_code_gen_t,
...
extern "C" {
    ...
    /// to.
    pub fn thinlto_module_get_num_objects(
        cg: thinlto_code_gen_t,
    ) -> ::libc::c_int;
    ...
    pub fn thinlto_module_get_num_object_files(
        cg: thinlto_code_gen_t,
    ) -> ::libc::c_uint;
    ...
    pub fn thinlto_codegen_set_cache_dir(
        cg: thinlto_code_gen_t,
    ...
    pub fn lto_input_get_num_dependent_libraries(
        input: lto_input_t,
    ) -> ::libc::c_uint;
    ...
    pub fn lto_runtime_lib_symbols_list(
        size: *mut usize,
    ...
    pub fn thinlto_codegen_set_cpu(
        cg: thinlto_code_gen_t,
    ...
    pub fn thinlto_codegen_disable_codegen(
        cg: thinlto_code_gen_t,
        disable: lto_bool_t,
    );
    /// Perform codegen only; disable all other stages.
    pub fn thinlto_codegen_set_codegen_only(
        cg: thinlto_code_gen_t,
        codegen_only: lto_bool_t,
    );
    /// Parse -mllvm style debug options.
    pub fn thinlto_debug_options(
