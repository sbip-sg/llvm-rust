...
extern "C" {
    ...
    pub fn LLVMContextGetDiagnosticHandler(
        C: LLVMContextRef,
    ) -> LLVMDiagnosticHandler;
    /// Get the diagnostic context of this context.
    pub fn LLVMContextGetDiagnosticContext(
        C: LLVMContextRef,
    ) -> *mut ::libc::c_void;
    ...
    pub fn LLVMContextSetDiscardValueNames(
        C: LLVMContextRef,
        Discard: LLVMBool,
    );
    pub fn LLVMContextDispose(C: LLVMContextRef);
    pub fn LLVMGetDiagInfoDescription(
        DI: LLVMDiagnosticInfoRef,
    ) -> *mut ::libc::c_char;
    pub fn LLVMGetDiagInfoSeverity(
        DI: LLVMDiagnosticInfoRef,
...
// Core->Modules
extern "C" {
    pub fn LLVMModuleCreateWithName(
    ...
    pub fn LLVMGetNextNamedMetadata(
        NamedMDNode: LLVMNamedMDNodeRef,
    ) -> LLVMNamedMDNodeRef;
    pub fn LLVMGetPreviousNamedMetadata(
        NamedMDNode: LLVMNamedMDNodeRef,
    ) -> LLVMNamedMDNodeRef;
...
extern "C" {
    ...
    pub fn LLVMCountStructElementTypes(StructTy: LLVMTypeRef)
        -> ::libc::c_uint;
    pub fn LLVMGetStructElementTypes(
        StructTy: LLVMTypeRef,
    ...
    pub fn LLVMGetPointerAddressSpace(PointerTy: LLVMTypeRef)
        -> ::libc::c_uint;
...
extern "C" {
    ...
    pub fn LLVMGetOperand(
        Val: LLVMValueRef,
        Index: ::libc::c_uint,
    ) -> LLVMValueRef;
    pub fn LLVMGetOperandUse(
        Val: LLVMValueRef,
        Index: ::libc::c_uint,
    ) -> LLVMUseRef;
    pub fn LLVMSetOperand(
        User: LLVMValueRef,
        Index: ::libc::c_uint,
        Val: LLVMValueRef,
    );
    ...
    pub fn LLVMConstIntGetSExtValue(
        ConstantVal: LLVMValueRef,
    ) -> ::libc::c_longlong;
    ...
    pub fn LLVMAPIntGetNumWords(ConstantVal: LLVMValueRef) -> ::libc::c_uint;
    pub fn LLVMAPIntGetAllWords(
        ConstantVal: LLVMValueRef,
        numWords: *mut ::libc::size_t,
    ) -> *const u64;
    ...
    pub fn LLVMGetElementAsConstant(
        C: LLVMValueRef,
        idx: ::libc::c_uint,
    ) -> LLVMValueRef;
    ...
    pub fn LLVMConstNSWAdd(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstNUWAdd(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFAdd(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstSub(
    ...
    pub fn LLVMConstNSWSub(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstNUWSub(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFSub(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstMul(
    ...
    pub fn LLVMConstNSWMul(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstNUWMul(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFMul(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstUDiv(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstExactUDiv(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstSDiv(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstExactSDiv(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFDiv(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstURem(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstSRem(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFRem(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstAnd(
    ...
    pub fn LLVMConstLShr(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstAShr(
        LHSConstant: LLVMValueRef,
        RHSConstant: LLVMValueRef,
    ) -> LLVMValueRef;
    #[deprecated(
    ...
    pub fn LLVMConstTrunc(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstSExt(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstZExt(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFPTrunc(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFPExt(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstUIToFP(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstSIToFP(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFPToUI(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstFPToSI(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstPtrToInt(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstIntToPtr(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstBitCast(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstAddrSpaceCast(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstZExtOrBitCast(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstSExtOrBitCast(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstTruncOrBitCast(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    pub fn LLVMConstPointerCast(
        ConstantVal: LLVMValueRef,
        ToType: LLVMTypeRef,
    ) -> LLVMValueRef;
    ...
    pub fn LLVMDisposeValueMetadataEntries(
    ...
    pub fn LLVMGetThreadLocalMode(
        GlobalVar: LLVMValueRef,
    ) -> LLVMThreadLocalMode;
    pub fn LLVMSetThreadLocalMode(
        GlobalVar: LLVMValueRef,
        Mode: LLVMThreadLocalMode,
    );
    pub fn LLVMIsExternallyInitialized(GlobalVar: LLVMValueRef) -> LLVMBool;
    pub fn LLVMSetExternallyInitialized(
        GlobalVar: LLVMValueRef,
        IsExtInit: LLVMBool,
    );
...
extern "C" {
    #[deprecated(
        since = "LLVM 9.0",
        note = "Use LLVMMDStringInContext2 instead."
    )]
    ...
    #[deprecated(
        since = "LLVM 9.0",
        note = "Use LLVMMDNodeInContext2 instead."
    )]
    ...
    pub fn LLVMSetGlobalIFuncResolver(
        IFunc: LLVMValueRef,
        Resolver: LLVMValueRef,
    );
...
extern "C" {
    ...
    pub fn LLVMGetPreviousBasicBlock(
        BB: LLVMBasicBlockRef,
    ) -> LLVMBasicBlockRef;
    ...
    pub fn LLVMAppendExistingBasicBlock(
        Fn: LLVMValueRef,
        BB: LLVMBasicBlockRef,
    );
    ...
    pub fn LLVMMoveBasicBlockBefore(
        BB: LLVMBasicBlockRef,
        MovePos: LLVMBasicBlockRef,
    );
    pub fn LLVMMoveBasicBlockAfter(
        BB: LLVMBasicBlockRef,
        MovePos: LLVMBasicBlockRef,
    );
...
extern "C" {
    ...
    // Operations with Binary Operator.
    pub fn LLVMHasNoUnsignedWrap(Inst: LLVMValueRef) -> LLVMBool;
    pub fn LLVMHasNoSignedWrap(Inst: LLVMValueRef) -> LLVMBool;

    // Get the signedness of an Instruction.
    pub fn LLVMGetSignednessInfo(Inst: LLVMValueRef) -> i32;
    pub fn LLVMGetDbgDeclareVar(Inst: LLVMValueRef) -> LLVMValueRef;
...
extern "C" {
    ...
    pub fn LLVMGetCurrentDebugLocation2(
        Builder: LLVMBuilderRef,
    ) -> LLVMMetadataRef;
    /// Set location information used by debugging information.
    pub fn LLVMSetCurrentDebugLocation2(
        Builder: LLVMBuilderRef,
        Loc: LLVMMetadataRef,
    );
    ...
    pub fn LLVMSetInstDebugLocation(
        Builder: LLVMBuilderRef,
        Inst: LLVMValueRef,
    );
    ...
    pub fn LLVMBuilderGetDefaultFPMathTag(
        Builder: LLVMBuilderRef,
    ) -> LLVMMetadataRef;
    /// Set the default floating-point math metadata for the given builder.
    pub fn LLVMBuilderSetDefaultFPMathTag(
        Builder: LLVMBuilderRef,
        FPMathTag: LLVMMetadataRef,
    );
    #[deprecated(
        since = "LLVM 9.0",
        note = "Use LLVMGetCurrentDebugLocation2 instead."
    )]
    pub fn LLVMSetCurrentDebugLocation(
        Builder: LLVMBuilderRef,
        L: LLVMValueRef,
    );
    pub fn LLVMGetCurrentDebugLocation(Builder: LLVMBuilderRef)
        -> LLVMValueRef;
    ...
    pub fn LLVMGetArgOperand(
        Funclet: LLVMValueRef,
        i: ::libc::c_uint,
    ) -> LLVMValueRef;

    /// Set a funcletpad argument at the given index.
    pub fn LLVMSetArgOperand(
        Funclet: LLVMValueRef,
        i: ::libc::c_uint,
        value: LLVMValueRef,
    );
    ...
    /// This only works on llvm::CatchPadInst instructions.
    pub fn LLVMSetParentCatchSwitch(
        CatchPad: LLVMValueRef,
        CatchSwitch: LLVMValueRef,
    );
    ...
    pub fn LLVMGetAtomicRMWBinOp(
        AtomicRMWInst: LLVMValueRef,
    ) -> LLVMAtomicRMWBinOp;
    pub fn LLVMSetAtomicRMWBinOp(
        AtomicRMWInst: LLVMValueRef,
    ...
    pub fn LLVMSetAtomicSingleThread(
        AtomicInst: LLVMValueRef,
        SingleThread: LLVMBool,
    );
    pub fn LLVMGetCmpXchgSuccessOrdering(
        CmpXchgInst: LLVMValueRef,
    ) -> LLVMAtomicOrdering;
    pub fn LLVMSetCmpXchgSuccessOrdering(
        CmpXchgInst: LLVMValueRef,
        Ordering: LLVMAtomicOrdering,
    );
    pub fn LLVMGetCmpXchgFailureOrdering(
        CmpXchgInst: LLVMValueRef,
    ) -> LLVMAtomicOrdering;
    pub fn LLVMSetCmpXchgFailureOrdering(
        CmpXchgInst: LLVMValueRef,
        Ordering: LLVMAtomicOrdering,
    );
}
...
extern "C" {
    pub fn LLVMCreateModuleProviderForExistingModule(
        M: LLVMModuleRef,
...
extern "C" {
    ...
    pub fn LLVMCreateFunctionPassManagerForModule(
        M: LLVMModuleRef,
    ) -> LLVMPassManagerRef;
    pub fn LLVMCreateFunctionPassManager(
        MP: LLVMModuleProviderRef,
    ) -> LLVMPassManagerRef;
    pub fn LLVMRunPassManager(
        PM: LLVMPassManagerRef,
        M: LLVMModuleRef,
    ) -> LLVMBool;
    pub fn LLVMInitializeFunctionPassManager(
        FPM: LLVMPassManagerRef,
    ) -> LLVMBool;
    pub fn LLVMRunFunctionPassManager(
        FPM: LLVMPassManagerRef,
        F: LLVMValueRef,
    ) -> LLVMBool;
