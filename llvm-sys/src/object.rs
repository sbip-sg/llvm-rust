...
extern "C" {
    ...
    pub fn LLVMBinaryCopyMemoryBuffer(BR: LLVMBinaryRef)
        -> LLVMMemoryBufferRef;
    ...
    pub fn LLVMObjectFileCopySectionIterator(
        BR: LLVMBinaryRef,
    ...
    pub fn LLVMObjectFileCopySymbolIterator(
        BR: LLVMBinaryRef,
    ...
    pub fn LLVMMoveToContainingSection(
    ...
    pub fn LLVMGetRelocationSymbol(
        RI: LLVMRelocationIteratorRef,
    ) -> LLVMSymbolIteratorRef;
