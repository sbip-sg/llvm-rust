...
extern "C" {
    ...
    pub fn LLVMRemarkStringGetData(
...
extern "C" {
    ...
    pub fn LLVMRemarkDebugLocGetSourceFilePath(
...
extern "C" {
    ...
    pub fn LLVMRemarkArgGetDebugLoc(
...
extern "C" {
    ...
    pub fn LLVMRemarkEntryGetType(Remark: LLVMRemarkEntryRef)
        -> LLVMRemarkType;

    /// Get the name of the pass that emitted this remark.
    pub fn LLVMRemarkEntryGetPassName(
        Remark: LLVMRemarkEntryRef,
    ) -> LLVMRemarkStringRef;

    /// Get an identifier of the remark.
    pub fn LLVMRemarkEntryGetRemarkName(
        Remark: LLVMRemarkEntryRef,
    ) -> LLVMRemarkStringRef;

    /// Get the name of the function being processed when the remark was emitted.
    pub fn LLVMRemarkEntryGetFunctionName(
        Remark: LLVMRemarkEntryRef,
    ) -> LLVMRemarkStringRef;

    /// Returns the debug location that is attached to this remark.
    pub fn LLVMRemarkEntryGetDebugLoc(
        Remark: LLVMRemarkEntryRef,
    ) -> LLVMRemarkDebugLocRef;
    ...
    pub fn LLVMRemarkEntryGetFirstArg(
        Remark: LLVMRemarkEntryRef,
    ) -> LLVMRemarkArgRef;
...
extern "C" {
    ...
    pub fn LLVMRemarkParserCreateYAML(
    ...
    pub fn LLVMRemarkParserGetNext(
    ...
    pub fn LLVMRemarkParserGetErrorMessage(
        Parser: LLVMRemarkParserRef,
    ) -> *const ::libc::c_char;
