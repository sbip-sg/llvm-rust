...
pub type LLVMOrcErrorReporterFunction =
    extern "C" fn(Ctx: *mut ::libc::c_void, Err: LLVMErrorRef);
...
pub type LLVMOrcMaterializationResponsibilityRef =
    *mut LLVMOrcOpaqueMaterializationResponsibility;

pub type LLVMOrcMaterializationUnitMaterializeFunction = extern "C" fn(
    Ctx: *mut ::libc::c_void,
...
pub type LLVMOrcMaterializationUnitDestroyFunction =
    extern "C" fn(Ctx: *mut ::libc::c_void);
...
pub type LLVMOrcCAPIDefinitionGeneratorTryToGenerateFunction =
    extern "C" fn(
...
pub type LLVMOrcJITTargetMachineBuilderRef =
    *mut LLVMOrcOpaqueJITTargetMachineBuilder;
...
pub type LLVMOrcIRTransformLayerTransformFunction =
    extern "C" fn(
        Ctx: *mut ::libc::c_void,
...
pub type LLVMOrcObjectTransformLayerRef =
    *mut LLVMOrcOpaqueObjectTransformLayer;
...
pub type LLVMOrcIndirectStubsManagerRef =
    *mut LLVMOrcOpaqueIndirectStubsManager;

#[derive(Debug)]
pub enum LLVMOrcOpaqueLazyCallThroughManager {}
pub type LLVMOrcLazyCallThroughManagerRef =
...
extern "C" {
    ...
    pub fn LLVMOrcSymbolStringPoolClearDeadEntries(
    ...
    pub fn LLVMOrcRetainSymbolStringPoolEntry(
        S: LLVMOrcSymbolStringPoolEntryRef,
    );
    pub fn LLVMOrcReleaseSymbolStringPoolEntry(
        S: LLVMOrcSymbolStringPoolEntryRef,
    );
    ...
    pub fn LLVMOrcResourceTrackerRemove(
    ...
    pub fn LLVMOrcDisposeJITTargetMachineBuilder(
    ...
    pub fn LLVMOrcDisposeLazyCallThroughManager(
        LCTM: LLVMOrcLazyCallThroughManagerRef,
    );
