...
extern "C" {
    ...
    pub fn LLVMOrcLLJITGetMainJITDylib(
        J: LLVMOrcLLJITRef,
    ) -> LLVMOrcJITDylibRef;
    pub fn LLVMOrcLLJITGetTripleString(
        J: LLVMOrcLLJITRef,
    ) -> *const ::libc::c_char;
    ...
    pub fn LLVMOrcLLJITGetObjLinkingLayer(
        J: LLVMOrcLLJITRef,
    ) -> LLVMOrcObjectLayerRef;
    pub fn LLVMOrcLLJITGetObjTransformLayer(
        J: LLVMOrcLLJITRef,
    ) -> LLVMOrcObjectTransformLayerRef;
    pub fn LLVMOrcLLJITGetIRTransformLayer(
        J: LLVMOrcLLJITRef,
    ) -> LLVMOrcIRTransformLayerRef;
    pub fn LLVMOrcLLJITGetDataLayoutStr(
        J: LLVMOrcLLJITRef,
    ) -> *const ::libc::c_char;
}
