...
pub type LLVMMemoryManagerFinalizeMemoryCallback = extern "C" fn(
    Opaque: *mut ::libc::c_void,
...
extern "C" {
    ...
    pub fn LLVMCreateGenericValueOfPointer(
        P: *mut ::libc::c_void,
    ) -> LLVMGenericValueRef;
    ...
    pub fn LLVMGenericValueIntWidth(
    ...
    pub fn LLVMGenericValueToPointer(
        GenVal: LLVMGenericValueRef,
    ) -> *mut ::libc::c_void;
    ...
    pub fn LLVMFreeMachineCodeForFunction(
        EE: LLVMExecutionEngineRef,
        F: LLVMValueRef,
    );
    ...
    pub fn LLVMGetExecutionEngineTargetData(
        EE: LLVMExecutionEngineRef,
    ) -> LLVMTargetDataRef;
    pub fn LLVMGetExecutionEngineTargetMachine(
        EE: LLVMExecutionEngineRef,
