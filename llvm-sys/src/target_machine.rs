...
extern "C" {
    ...
    pub fn LLVMGetTargetMachineTarget(T: LLVMTargetMachineRef)
        -> LLVMTargetRef;
    pub fn LLVMGetTargetMachineTriple(
        T: LLVMTargetMachineRef,
    ) -> *mut ::libc::c_char;
    pub fn LLVMGetTargetMachineCPU(
        T: LLVMTargetMachineRef,
    ) -> *mut ::libc::c_char;
    ...
    pub fn LLVMCreateTargetDataLayout(
        T: LLVMTargetMachineRef,
    ) -> LLVMTargetDataRef;
    pub fn LLVMSetTargetMachineAsmVerbosity(
        T: LLVMTargetMachineRef,
        VerboseAsm: LLVMBool,
    );
