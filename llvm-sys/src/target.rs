...
extern "C" {
    ...
    pub fn LLVMCreateTargetData(
        StringRep: *const ::libc::c_char,
    ) -> LLVMTargetDataRef;
    pub fn LLVMAddTargetLibraryInfo(
        TLI: LLVMTargetLibraryInfoRef,
        PM: LLVMPassManagerRef,
    );
    pub fn LLVMCopyStringRepOfTargetData(
    ...
    pub fn LLVMIntPtrTypeForAS(
        TD: LLVMTargetDataRef,
        AS: ::libc::c_uint,
    ) -> LLVMTypeRef;
    pub fn LLVMIntPtrTypeInContext(
        C: LLVMContextRef,
        TD: LLVMTargetDataRef,
    ) -> LLVMTypeRef;
    ...
    pub fn LLVMABISizeOfType(
        TD: LLVMTargetDataRef,
        Ty: LLVMTypeRef,
    ) -> ::libc::c_ulonglong;
    pub fn LLVMABIAlignmentOfType(
        TD: LLVMTargetDataRef,
        Ty: LLVMTypeRef,
    ) -> ::libc::c_uint;
