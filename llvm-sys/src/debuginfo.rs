...
pub const LLVMDIFlagPtrToMemberRep: LLVMDIFlags = LLVMDIFlagSingleInheritance
...
extern "C" {
    ...
    pub fn LLVMGetModuleDebugMetadataVersion(
    ...
    pub fn LLVMCreateDIBuilderDisallowUnresolved(
        M: LLVMModuleRef,
    ) -> LLVMDIBuilderRef;
    ...
    pub fn LLVMDIBuilderFinalizeSubprogram(
    ...
    pub fn LLVMDILocationGetColumn(Location: LLVMMetadataRef)
        -> ::libc::c_uint;

    /// Get the local scope associated with this debug location.
    pub fn LLVMDILocationGetScope(Location: LLVMMetadataRef)
        -> LLVMMetadataRef;

    /// Get the "inline at" location associated with this debug location.
    pub fn LLVMDILocationGetInlinedAt(
    ...
    pub fn LLVMDIBuilderCreateNullPtrType(
        Builder: LLVMDIBuilderRef,
    ) -> LLVMMetadataRef;
    ...
    pub fn LLVMDISubprogramGetFlags(
        DISubprogram: LLVMMetadataRef,
    ) -> LLVMDIFlags;
    ...
    pub fn LLVMDIGlobalVariableExpressionGetVariable(
        GVE: LLVMMetadataRef,
    ) -> LLVMMetadataRef;

    /// Retrieves the DIExpression associated with this global variable expression.
    pub fn LLVMDIGlobalVariableExpressionGetExpression(
        GVE: LLVMMetadataRef,
    ) -> LLVMMetadataRef;
    ...
    pub fn LLVMDISubprogramGetLine(
        Subprogram: LLVMMetadataRef,
    ) -> ::libc::c_uint;
