Safe Rust bindings to LLVM's C API.
=========================================

# Note

- This is a fork of the [inkwell](https://github.com/TheDan64/inkwell/issues/2) to support new C bindings provided by the
  [llvm-project](https://github.com/sbip-sg/llvm-project) repository of SBIP.

- Changes in this fork, if applicable, will be gradually merged back to the
  original [inkwell](https://github.com/TheDan64/inkwell/issues/2).
