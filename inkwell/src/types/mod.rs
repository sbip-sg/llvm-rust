...
pub use crate::types::enums::{
    AnyTypeEnum, BasicMetadataTypeEnum, BasicTypeEnum,
};
...
pub use crate::types::traits::{
    AnyType, BasicType, FloatMathType, IntMathType, PointerMathType,
};
...
use llvm_sys::core::{
    LLVMAlignOf, LLVMArrayType, LLVMConstNull, LLVMConstPointerNull,
    LLVMFunctionType, LLVMGetElementType, LLVMGetTypeContext, LLVMGetTypeKind,
    LLVMGetUndef, LLVMPointerType, LLVMPrintTypeToString, LLVMSizeOf,
...
impl fmt::Debug for Type<'_> {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        let llvm_type = self.print_to_llvm_string();
