...
use crate::types::{
    traits::AsTypeRef, ArrayType, BasicTypeEnum, FunctionType, PointerType,
    Type,
};
use crate::values::{
    ArrayValue, AsValueRef, BasicValue, IntValue, VectorValue,
};
...
impl<'ctx> VectorType<'ctx> {
    ...
    pub fn print_to_llvm_string(self) -> LLVMString {
        self.vec_type.print_to_llvm_string()
    }
