use llvm_sys::core::{
    LLVMConstAddrSpaceCast, LLVMConstGEP, LLVMConstInBoundsGEP,
    LLVMConstPointerCast, LLVMConstPtrToInt,
};
...
impl<'ctx> PointerValue<'ctx> {
    ...
    /// Gets the name of a `PointerValue`. If the value is a constant, this will
...
impl<'ctx> AsValueRef for PointerValue<'ctx> {
    fn as_value_ref(&self) -> LLVMValueRef {
        self.ptr_value.value
    }
}

impl<'ctx> Display for PointerValue<'ctx> {
