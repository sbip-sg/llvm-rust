use llvm_sys::core::{
    LLVMCreateFunctionPassManagerForModule, LLVMCreatePassManager,
    LLVMDisposePassManager, LLVMFinalizeFunctionPassManager,
    LLVMGetGlobalPassRegistry, LLVMInitializeFunctionPassManager,
    LLVMRunFunctionPassManager, LLVMRunPassManager,
};
use llvm_sys::initialization::{
    LLVMInitializeAnalysis, LLVMInitializeCodeGen, LLVMInitializeCore,
    LLVMInitializeIPA, LLVMInitializeIPO, LLVMInitializeInstCombine,
    LLVMInitializeInstrumentation, LLVMInitializeObjCARCOpts,
    LLVMInitializeScalarOpts, LLVMInitializeTarget,
...
use llvm_sys::transforms::ipo::{
    LLVMAddAlwaysInlinerPass, LLVMAddArgumentPromotionPass,
    LLVMAddConstantMergePass, LLVMAddDeadArgEliminationPass,
    LLVMAddFunctionAttrsPass, LLVMAddFunctionInliningPass,
    LLVMAddGlobalDCEPass, LLVMAddGlobalOptimizerPass, LLVMAddIPSCCPPass,
    LLVMAddInternalizePass, LLVMAddPruneEHPass, LLVMAddStripDeadPrototypesPass,
...
use llvm_sys::transforms::scalar::{
    LLVMAddAggressiveDCEPass, LLVMAddAlignmentFromAssumptionsPass,
    LLVMAddBasicAliasAnalysisPass, LLVMAddCFGSimplificationPass,
    LLVMAddCorrelatedValuePropagationPass, LLVMAddDeadStoreEliminationPass,
    LLVMAddDemoteMemoryToRegisterPass, LLVMAddEarlyCSEPass, LLVMAddGVNPass,
    LLVMAddIndVarSimplifyPass, LLVMAddInstructionCombiningPass,
    LLVMAddJumpThreadingPass, LLVMAddLICMPass, LLVMAddLoopDeletionPass,
    LLVMAddLoopIdiomPass, LLVMAddLoopRerollPass, LLVMAddLoopRotatePass,
    LLVMAddLoopUnrollPass, LLVMAddLoopUnswitchPass,
    LLVMAddLowerExpectIntrinsicPass, LLVMAddMemCpyOptPass,
    LLVMAddMergedLoadStoreMotionPass, LLVMAddPartiallyInlineLibCallsPass,
    LLVMAddReassociatePass, LLVMAddSCCPPass, LLVMAddScalarReplAggregatesPass,
    LLVMAddScalarReplAggregatesPassSSA,
    LLVMAddScalarReplAggregatesPassWithThreshold, LLVMAddScalarizerPass,
    LLVMAddScopedNoAliasAAPass, LLVMAddSimplifyLibCallsPass,
    LLVMAddTailCallEliminationPass, LLVMAddTypeBasedAliasAnalysisPass,
    LLVMAddVerifierPass,
};
use llvm_sys::transforms::vectorize::{
    LLVMAddLoopVectorizePass, LLVMAddSLPVectorizePass,
};
...
use llvm_sys::transforms::pass_builder::{
    ...
    LLVMPassBuilderOptionsRef, LLVMPassBuilderOptionsSetCallGraphProfile,
