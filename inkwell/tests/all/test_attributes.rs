...
fn test_string_attributes() {
    ...
    let string_attribute =
        context.create_string_attribute("my_key_123", "my_val");
...
fn test_attributes_on_call_site_values() {
    ...
    call_site_value
        .remove_enum_attribute(AttributeLoc::Return, alignstack_attribute); // Noop
    ...
    call_site_value
        .remove_enum_attribute(AttributeLoc::Return, alignstack_attribute);
